...
ApplicationWindow {
    ...
    Image  {
        ...
        source: "qrc:/qt/qml/com/iktwo/qutelauncher/qml/resources/images/shadow"
    }
    ...
    Image  {
        ...
        source: QL.ScreenValues.navBarVisible ? "qrc:/qt/qml/com/iktwo/qutelauncher/qml/resources/images/shadow_navigationbar" : ""
    }
    ...
    Connections {
        ...
        function onAddedApplicationToGrid(name, packageName) {
            ...
            var newItem = {'name': name, 'packageName': packageName}
            favs.push(newItem)
            favoritesData = favs
        }
    }
