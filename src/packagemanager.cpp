    ...
    QAbstractListModel(parent)
{
    ...
    connect(this, &PackageManager::newApplicationDetected, this, &PackageManager::addApplication);
    connect(this, &PackageManager::removedApplication, this, &PackageManager::removeApplication);
}
